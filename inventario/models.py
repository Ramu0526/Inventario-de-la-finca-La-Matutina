...
class Ganado(models.Model):
    ...
    imagen = models.ImageField(upload_to='ganado/', null=True, blank=True)
...
class ControlPlaga(models.Model):
    ...
    imagen = models.ImageField(upload_to='control_plagas/', null=True, blank=True)
...
class Potrero(models.Model):
    ...
    imagen = models.ImageField(upload_to='potreros/', null=True, blank=True)
    def __str__(self): return self.nombre
...
class Mantenimiento(models.Model):
    ...
    imagen = models.ImageField(upload_to='mantenimiento/', null=True, blank=True)
...
class Combustible(models.Model):
    ...
    imagen = models.ImageField(upload_to='combustible/', null=True, blank=True)
